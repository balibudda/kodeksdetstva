...
<p class="frame">Эта страница для тебя, подросток. Без нотаций и «сам виноват». Здесь коротко: что происходит, какие у тебя права и что можно сделать. Читать можно без интернета. Здесь открыто говорят о тяжёлых вещах, но нигде нет описания того, как причинить себе вред, — только как распознать беду и куда обратиться.</p>
