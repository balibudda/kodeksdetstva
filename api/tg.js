...
// Вебхук: POST https://bot.kodeksdetstva.ru/api/tg (НЕ на основном домене —
// он теперь отдаётся статикой через GitHub Pages/Cloudflare и /api/* там
// недоступен; проверено вживую 14.09.2026 — вебхук и так был правильно
// зарегистрирован на поддомене, это лишь была устаревшая заметка в
// комментарии, не реальный баг).
